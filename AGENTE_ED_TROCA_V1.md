...
> **Existe um `troca16_short.py`** — 2 takes de 8s, destino **AdBatch Vertical
...
`python funil-organico/medir_copy16.py --motor troca16`:
...
```
CT1 100% · CT2 78% · CT3 55% · CT4 100% · CT6 95%
```

⚠️ E o defeito específico dele: o take 1 prometia TAMANHO (`grow a full inch`) contra uma VSL de ereccao, e o take 2 abria em demonstrativo sem dono (`Set that down.`).
