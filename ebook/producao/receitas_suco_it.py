...
tratamento por "tu", vocabulario de cozinha italiana de verdade (purè, vellutata,
spezzatino, frullato, fiocchi di latte, frutti di bosco).
...
⏳ ANDAIME: por ora so' o campo `nome` esta em italiano — os demais campos
   entram no passo desta categoria.
"""
