...
camote, crema de cacahuate, jitomate, fresa, frutos rojos).
⛔ METRICO: g, ml, °C, kg, km — como pt/de/fr. O EN e' o unico imperial do
...
⏳ ANDAIME: por ora so' o campo `nome` esta em espanhol — os demais campos
