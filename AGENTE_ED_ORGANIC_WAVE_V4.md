...
- **O que realmente protege:** imperfeição específica e assimétrica no rosto —
  ver [`espinha-fixa`](funil-organico/espinha-fixa.md) §Construir o REF contra
  a celebridade. Rosto que nenhuma celebridade tem não deriva para nenhuma.

⛔ **NÃO repetir a cláusula no TAKE** (correção do operador, 2026-07-28 — eu
tinha gravado o contrário aqui e estava errado). O take já trava o rosto com
`Maintain the subjects from the first frame exactly`; a face vem do IMAGE
aprovado. Repetir `not a celebrity / not an actor / not a model` no prompt de
movimento é ruído — e ainda injeta o conceito de celebridade no
condicionamento, que é o oposto do objetivo. Se um vídeo barrar por pessoa
famosa, **o conserto é no REF/IMAGE**, nunca no take.

### Marca facial vale para TODO personagem, não só o REF

Mesma falha, segunda causa: no vídeo recusado só o **REF** tinha marca facial
(a regra da marca vive na `espinha-fixa`, escopada ao REF). Paciente e esposa
foram descritos de forma genérica — e **rosto genérico é o que deriva para
semelhança com celebridade**, porque o modelo preenche o vazio com a média do
treino, que é povoada de gente famosa.

> **Todo personagem humano no quadro leva pelo menos uma âncora facial
> memorável** — verruga, sardas, sobrancelha falhada, nariz bulboso, falha
> entre os dentes, cicatriz, orelha entalhada. Vale para vítima, esposa,
> amigo, testemunha nomeada. Só testemunha desfocada de fundo é dispensada
> (ela não tem rosto descrito por design).
