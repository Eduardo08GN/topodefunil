...
# -*- coding: utf-8 -*-
"""
AGENTE BOTICA SHORT — app desktop offline.

Ponto de entrada enxuto: a interface mora em ui_agente.py (compartilhada por
todos os agentes portados) e a doutrina em botica_short.py.
...
⛔ Ledger PROPRIO (`.botica-short-ledger.json`), como todo agente.

    python funil-organico/botica_short_app.py
"""
...
import botica_short as motor      # noqa: E402

# o ledger acompanha o executavel, nao a pasta temporaria do PyInstaller
motor.LEDGER = os.path.join(ui_agente.base_dir(), ".botica-short-ledger.json")
