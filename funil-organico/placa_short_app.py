...
# -*- coding: utf-8 -*-
"""
AGENTE PLACA SHORT — app desktop offline.

Ponto de entrada enxuto: a interface mora em ui_agente.py (compartilhada por
todos os agentes portados) e a doutrina em placa_short.py.
...
⛔ Ledger PROPRIO (`.placa-short-ledger.json`), como todo agente.

    python funil-organico/placa_short_app.py
"""
...
import placa_short as motor      # noqa: E402

# o ledger acompanha o executavel, nao a pasta temporaria do PyInstaller
motor.LEDGER = os.path.join(ui_agente.base_dir(), ".placa-short-ledger.json")
