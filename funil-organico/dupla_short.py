...
PROBLEMAS = [
    "If you want your small {o} to go from this",
    "If you want that soft {o} to go from this",
    "If you want your tired {o} to go from this",
    "If you want your {o} to go from this",
    "If your {o} looks like this and you want it to go from this",
    "If you are done with a small {o} and want it to go from this",
    "If you want that shrunken {o} to go from this",
    "If your {o} went quiet and you want it to go from this",
    "If you want your {o} to stop looking like this and go from this",
    "If that small {o} of yours needs to go from this",
    "If you want your {o} to move from this",
    "If your {o} is the one on the left and you want it to go from this",
]
...
FECHOS = [
    "just follow the recipe we are about to show you",
    "follow the recipe we are about to show you",
    "watch the recipe we are about to show you",
    "here is the recipe we are about to show you",
    "just follow what we are about to show you",
    "stay for the recipe we are about to show you",
    "follow along with what we are about to show you",
    "the recipe is right here, watch",
]
