...
# ⚠️ 6-8 palavras. Cada entrada nomeia SANGUE, PRESSAO e o ORGAO — sem os tres
# a frase vira "algo melhora la' dentro", que e' o drifting que o operador
# reprovou. ⛔ Nenhuma abre com pronome.
MECANISMOS16 = [
    "Blood with pressure firms your {o}.",
    "Your {o} firms on blood with pressure.",
    "Blood arriving with pressure firms your {o}.",
    "Your {o} runs on blood with pressure.",
    "What firms your {o} is blood with pressure.",
    "Firm is blood reaching your {o} with pressure.",
    "Your {o} firms when blood arrives with pressure.",
    "Blood under pressure is what firms your {o}.",
...
# o comentario do espectador sai com duas palavras e a automacao nao dispara.
# A lente T16-2 cobra isso.
FOLLOWS16 = [
    "Follow me first.",
    "Follow me too.",
    "Followers only.",
