...
# -*- coding: utf-8 -*-
"""
AGENTE COLO 16 — app desktop offline.
...
⛔ Ledger PROPRIO (`.colo-16-ledger.json`).

    python funil-organico/colo16_short_app.py
"""
...
import colo16_short as motor      # noqa: E402

# o ledger acompanha o executavel, nao a pasta temporaria do PyInstaller
motor.LEDGER = os.path.join(ui_agente.base_dir(), ".colo-16-ledger.json")
