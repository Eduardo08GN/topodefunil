...
# ⛔ ESTE MOTOR E' O IRMAO DO `wife16_short.py` e os dois pools de HOMENS sao
# identicos — os rotulos foram escritos iguais nos dois DE PROPOSITO: o mesmo
# rosto tem de ler igual nos dois paineis. Divergir aqui e' inventar diferenca
# onde o pool nao tem nenhuma.
