...
todos os agentes portados), a doutrina em flagrante_lucas.py e o colapso para
3 cenas em flagrante_short.py.

    python funil-organico/flagrante_short_app.py
"""
...
import flagrante_short as motor       # noqa: E402
