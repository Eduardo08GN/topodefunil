...
todos os agentes portados) e a doutrina em exterior16_short.py.
...
`exterior16_short.py` e' motor completo (pools proprios) e so' toma emprestada a
maquinaria compartilhada do `short_comum.py`.

    python funil-organico/exterior16_short_app.py
"""
...
import exterior16_short as motor             # noqa: E402
