# Template de Criativo — modelável (triangulado)

O output acionável da digestão. Pega o **piso validado** ([signature](signature-por-arquetipo.md)) e o transforma no molde do **nosso** criativo, preenchido pela **triangulação** ([insight](../00-mapa/insights-empiricos.md)):
...
| Slot | De onde vem | Ex. (a definir) |
|------|-------------|-----------------|
| `[MECANISMO]` | mecanismo único da oferta | ex.: óxido nítrico / fluxo sanguíneo |
| `[AVATAR]` | arquétipo mais congruente ([avatares](avatares-experts.md)) | autoridade / guru ancestral / wellness |
| `[PROP]` | prop que **demonstra o mecanismo real** ([catálogo](prop-metaforas.md)) | ex.: beterraba/óxido nítrico |
...
- [ ] Prova real e verificável.
- [ ] Disclosure de afiliado onde exigido; automação de DM dentro do ToS.
