# Catálogo de Prop-Metáforas

O **prop** é o motor da signature: um objeto caseiro nos primeiros 1–2s que comunica o tema (ED / tamanho / firmeza / "cortisol") **sem áudio** e trava o scroll. Catalogado das 42 análises ([matriz](signature-matriz.md)). Serve pra **modelar o formato** — não os claims.

- **Status:** ✅ consolidado

## As 3 funções que um prop cumpre
1. **Innuendo fálico** — objeto com forma/uso que sugere o pênis/ereção (choque + comunica o tema).
2. **Demonstração de mecanismo** — "experimento caseiro" que finge provar a fisiologia (fluxo, pureza, "desentupir").
3. **Contraste antes/depois** — dois estados lado a lado (declínio × vigor) = promessa de transformação.

## Catálogo (objeto → função → páginas)

| Prop | Função | Onde apareceu |
|------|--------|---------------|
| **Banana** (fresca × murcha, ou com fita métrica) | innuendo fálico / antes-depois | Tanisha, Zuberi, Kofi, Men's |
| **Pepino** (dois tamanhos) | innuendo fálico de tamanho | Zuberi, Kofi |
| **Berinjela** regada com líquido | innuendo fálico "molhado" | Zuberi |
| **Milho + pasta de dente** (Crest) | innuendo fálico extremo | Kofi (reel Target) |
| **Linguiça** (pálida × vermelha/chouriço) | antes-depois fálico | Men's |
| **Marisco/geoduck** ("pescoço" alongado) | innuendo fálico grotesco | Zuberi |
| **Conchas "Day 1 / Day 7"** | antes-depois de crescimento | Zuberi |
| **Modelo anatômico** (pênis/próstata/rim) **regado com líquido vermelho/laranja** | demonstração de "fluxo sanguíneo" | Nitric, Men's, Zuberi |
| **Bomba peniana × modelo anatômico rosa** | antes-depois "solução × órgão" | Men's |
| **Escultura fálica escorrendo azeite** | mecanismo "desentupir vasos" | Olivia |
| **Vulcão de bicarbonato / bicarbonato em água** | demonstração de "pureza/absorção" | Nitric, Kofi |
| **Torso coberto de "cortisol" raspado com moeda** | mecanismo (gordura hormonal removida) | Olivia |
| **Raízes de gengibre/cúrcuma com forma testicular** | innuendo anatômico | Nitric |
| **Baguete de pão** | piada fálica | Nitric |
| **Post-it "NOT AVAILABLE" sobre a virilha** | gag de disfunção | Zuberi |
| **Cartão "MALE PENIS (SOFT)" / diagrama de artéria** | pseudo-diagnóstico clínico | Zuberi, Olivia, Men's |
| **Viagra genérico derramando × frasco natural** | contraste farmácia × natural | Olivia |
| **Mesa "burnout"** (pizza, Red Bull, despertador 5:30) | cenário de "vida estressante" | Tanisha |
| **Liquidificador / panela fervendo** (beterraba, limão, gengibre, mel) | demonstração de receita (ASMR) | todas |

## Props de autoridade (não-metáfora, mas recorrentes)
- **Jaleco / scrubs / luvas de nitrila / crachá** (autoridade médica encenada).
- **Diplomas emoldurados, pôster anatômico, modelo 3D, CGI de corpo** (verniz científico).
- **Print de paper real fora de contexto** (ex.: açafrão/safranal) e **gráfico "cortisol decreasing"** (pseudo-dado).
