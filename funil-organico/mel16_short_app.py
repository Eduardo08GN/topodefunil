...
# -*- coding: utf-8 -*-
"""
AGENTE MEL 16 — app desktop offline.
...
⛔ Ledger PROPRIO (`.mel-16-ledger.json`).
...
import mel16_short as motor      # noqa: E402

# o ledger acompanha o executavel, nao a pasta temporaria do PyInstaller
motor.LEDGER = os.path.join(ui_agente.base_dir(), ".mel-16-ledger.json")
