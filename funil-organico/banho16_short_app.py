...
# -*- coding: utf-8 -*-
"""
AGENTE BANHO 16 — app desktop offline.
...
⛔ Ledger PROPRIO (`.banho-16-ledger.json`).

    python funil-organico/banho16_short_app.py
"""
...
import banho16_short as motor      # noqa: E402

# o ledger acompanha o executavel, nao a pasta temporaria do PyInstaller
motor.LEDGER = os.path.join(ui_agente.base_dir(), ".banho-16-ledger.json")
