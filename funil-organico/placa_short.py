...
# ⭐ AS REGIOES DOS EUA que este angulo usa. A etnia sai de dentro do mundo
# (padrao "a etnia arrasta o mundo"), entao trocar de regiao troca cozinha,
# traje, luz e audio junto — nao so' o rosto.
_EUA_SO = ("amish", "americana_comum", "apalache", "sulista", "gullah",
           "delta", "grandes_lagos", "creole", "atlanta", "harlem",
           "meio_oeste", "nova_inglaterra", "texas", "noroeste",
           "italo_americana", "polonesa")
MUNDOS = [m for m in _TODOS_MUNDOS if m["id"] in _EUA_SO]
