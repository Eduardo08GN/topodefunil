...
# -*- coding: utf-8 -*-
"""
AGENTE TRIO SHORT — app desktop offline.

Ponto de entrada enxuto: a interface mora em ui_agente.py (compartilhada por
todos os agentes portados) e a doutrina em trio_short.py.
...
⛔ Ledger PROPRIO (`.trio-short-ledger.json`), como todo agente.

    python funil-organico/trio_short_app.py
"""
...
import trio_short as motor      # noqa: E402

# o ledger acompanha o executavel, nao a pasta temporaria do PyInstaller
motor.LEDGER = os.path.join(ui_agente.base_dir(), ".trio-short-ledger.json")
