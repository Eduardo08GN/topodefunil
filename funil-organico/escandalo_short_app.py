...
todos os agentes portados) e a doutrina em escandalo_short.py.

⚠️ Como o TROCA e ao contrario dos demais SHORT, este nao colapsa um motor
longo: nao existe `escandalo_lucas.py`. O `escandalo_short.py` e' motor completo
(pools proprios) e so' toma emprestada a maquinaria compartilhada do
`short_comum.py`.

    python funil-organico/escandalo_short_app.py
"""
...
import escandalo_short as motor        # noqa: E402
