# 🫀 Copy Humana — Verdade > Técnica (o anti-bingo de copywriting)

**A segunda falha fatal, descoberta em campo.** A primeira era o morno (comercial de TV — [Doutrina](doutrina-criativa-agressiva.md)). A segunda é o oposto disfarçado de solução: a copy que **parece escrita por alguém que estudou 500 VSLs e encaixou todas as técnicas em 35 segundos**. Estrutura perfeita, humanidade zero. Os dois modos de falha disparam o MESMO radar anti-propaganda.

> **A regra:** quando o espectador percebe a técnica, a conexão morre. Halbert, Carlton, Bencivenga e Makepeace não escrevem pra parecer inteligentes — escrevem pra parecer **verdadeiros**. A reação-alvo é *"isso aconteceu de verdade"*, nunca *"que copy boa"*.
>
...
1. **Fala imperfeita, não roteiro.** Frases quebradas, reticências, "I don't know", "honestly?", recomeços. Se soa bem lida em voz alta num palco, tá errado — tem que soar como conversa gravada sem querer.
2. **Contexto ANTES (ou junto) da emoção.** Nunca pedir emoção que o espectador ainda não entende (o gasp órfão). O olhar dela chega COM o significado.
3. **O narrador não sabe que está vendendo.** Ele preferia não estar contando isso ("I don't post stuff like this. It's embarrassing"). Relutância = credibilidade. Entusiasmo de vendedor = radar.
4. **ZERO frases de catálogo.** Proibidas (e suas primas): *"nobody had the guts to tell you"* · *"here's what they don't want you to know"* · *"flip the switch/signal"* · *"everything wakes up"* · *"not back to normal — past it"* · *"picture her face"* · *"fair warning"*. Se a frase poderia estar em QUALQUER VSL, corta.
...
1. Leia em voz alta como conversa. Travou/soou "escrito"? → reescreve a frase.
2. Alguma linha existe em outra VSL do mundo? → corta.
3. Onde está a confissão (o detalhe que ele preferia esconder)? Não tem? → não tem copy.
4. O mecanismo tem hedge/fonte? Soa palestra? → empresta pra um "buddy"/médico e duvida.
5. Cada frase é filmável? PowerPoint detectado? → transforma em cena.
6. **Teste final:** a reação é *"isso aconteceu"* ou *"que copy boa"*? Segunda → reprova.

## Como convive com a agressividade (não é contradição)
...
- [Ultrarrealismo](../recursos/veo3-ultrarealismo.md) — o mesmo princípio no visual: imperfeição = verdade
- [Bencivenga](../mentores/gary-bencivenga/README.md) · [Signature Verbal](signature-verbal.md)
