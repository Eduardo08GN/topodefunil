...
- **🩸 Padrão de ultrarrealismo:** [veo3-ultrarealismo](veo3-ultrarealismo.md) — a perfeição também denuncia IA; bloco REALISM-SPEC obrigatório (pele/luz/câmera/ambiente/comportamento/áudio imperfeitos de propósito) + kill-list do "cheiro de IA" + teste-mãe.
- **⏱️ LEI de duração:** todo vídeo-criativo final ≤ **35 segundos** ([régua](../funil-organico/ataque-4-roteiro-maquina.md)).
