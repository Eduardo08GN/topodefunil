...
> **Existe um `flagrante16_short.py`** — 2 takes de 8s, destino **AdBatch Vertical
...
`python funil-organico/medir_copy16.py --motor flagrante16`:
...
```
CT1 100% · CT2 17% · CT3 95% · CT4 100%
```

⚠️ E o defeito específico dele: `soldier` para o orgao soa a filme de guerra nos EUA, e `turns that around` era rotulo sem dizer o que a gelatina faz com o sangue.
...
2. **Comissão do operador:** o Ed descreve a cena (ex.: "casamento, noiva com
...
| Ocasião | Por que dói |
|---|---|
| **casamento / renovação de votos** | o dia dele, arruinado na frente de todos — testado 2026-07-28 |
...
- **cruel:** ela ri com a sala, ri mais alto (dor máxima; o payoff da cena 4
  é ela não rir mais) — usado: casamento Joe 2026-07-28
- **constrangida:** ela desvia o olhar, mão no rosto (dó; o payoff é ela
  voltar a olhar pra ele) — usado: churrasco Ray 2026-07-28
- **devastada:** ela chora JUNTO com ele (a dor é dos dois; o payoff é ela
  chorar de novo na cena 4 — pelo motivo oposto). Comissão do operador
  2026-07-28, aniversário Matt. É o sabor de maior identificação do casal
  50+: ninguém é vilão, a falha é o vilão.
...
| **silêncio congelado** (mãos na boca, sussurro) | reação devastada — os dois chorando | dó — a sala inteira entendeu; dói mais em cena de casal (aniversário Matt, 2026-07-28) |
...
- **F12 — O PROXY FICA COLADO NA REGIÃO PUBIANA DA VÍTIMA (vocabulário
  ...
  **Frase travada para o IMAGE (adaptar prop e pose da vítima):**
  `holding a [prop] — no longer than his thumb — shriveled and wrinkled, skin
  dull and spotted, completely soft, folded over on itself and drooping
  straight down, hanging right beside the [seated/bowed] man's hips`
