@echo off
setlocal
title Veo Editor 2.0 By EDDIE - Instalacao
cd /d "%~dp0"

echo.
echo   ================================================
echo     Veo Editor 2.0 By EDDIE - instalacao
echo   ================================================
echo.
...
powershell -NoProfile -Command ^
  ...
  "$lnk = $ws.CreateShortcut([Environment]::GetFolderPath('Desktop') + '\Veo Editor 2.0 By EDDIE.lnk');" ^
  "$lnk.TargetPath = '%~dp0Veo Editor 2.0.bat';" ^
  "$lnk.WorkingDirectory = '%~dp0';" ^
  "$lnk.IconLocation = 'shell32.dll,177';" ^
  "$lnk.Description = 'Veo Editor 2.0 By EDDIE';" ^
  "$lnk.Save()"
...
echo     Abra pelo atalho "Veo Editor 2.0 By EDDIE"
